        ...
        <div className="story-body">
            <div className="story-padding">
                ...
                <p className="mt-0">
                    ...
                    frontend uses
                    React and TypeScript to make readability and the possibility expand as easy as possible. Expanding
                    on the styling framework minimalism accompanied by images and iconography make up the styling of the
                ...
                <p>
                    ...
                    In total the admin panel is only a couple thousand lines long but is able to manipulate all
